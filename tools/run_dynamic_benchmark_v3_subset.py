...
def build_subset_report(
    ...
    *,
    ...
    expected_grid = {
        (strategy, fixture_id) for strategy in strategies for fixture_id in selected_ids
    }
    observed_grid = {
    ...
    for fixture in selected_fixtures:
        ...
        expected_terminal_counts[terminal] = (
            expected_terminal_counts.get(terminal, 0) + 1
        )
    ...
    stable: dict[str, Any] = {
        ...
        "source_code": {
            "repository_relative_path": ("src/visiondata_gate/dynamic_benchmark_v3.py"),
