...
def build_suite(output_root: Path, *, seed: int) -> dict[str, Any]:
    ...
    payload = {
        ...
        "scenarios": rows,
        "boundary": (
            "This suite is deterministic synthetic fault injection. It proves local "
            "happy/failure semantics under one frozen contract, not production incident rates, "
            "customer validation, or hosted AgentTeams connectivity."
        ),
    }
