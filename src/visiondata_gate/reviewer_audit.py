...
This module turns the recurring Agent Infra reviewer questions into two
machine-readable snapshots:

* ``reviewer_feedback_audit.json`` separates official/mentor signals from
  public competitor self-descriptions and maps both to local evidence.
...
def build_reviewer_feedback_audit(
    ...
    rows = [
        {
            ...
            "source_ref": "goai_infra_live.txt#通用评审维度/场景价值",
            "signal": "真实、明确、具有代表性的场景问题，以及可复制/迁移价值",
            "reviewer_question": "为什么这个不是泛聊天或单点工具？相似工厂能否迁移？",
            "current_risk": "本地演示使用固定合成工业视觉批次，尚无授权企业 shadow test 或现场 KPI。",
            "local_evidence": [
        ...
        },
        {
            ...
            "signal": "AgentTeams 是协同设计基点，至少要能核验任务拆解、上下文传递和状态追踪。",
        ...
        },
        {
            ...
            "source_layer": official,
            "source_ref": "goai_infra_live.txt#评审关注/Skill工程体系与生态复用",
        ...
        },
        {
            ...
            "source_layer": official,
            "source_ref": "goai_infra_live.txt#工程落地与安全审计",
        ...
        },
        {
            ...
            "status": "OPEN",
            "status_basis": local,
            "missing_external_evidence": "顶层 LICENSE/NOTICE 权利主体确认、公开仓库链接和 tag。",
            "verification_command": ".venv\\Scripts\\python.exe -m pytest -q tests/test_supply_chain_artifacts.py",
            "next_action": "完成权利主体确认后再决定开源许可证和公开仓库；当前不声称已完全开源。",
            "overclaim_boundary": "SBOM 不是许可证授权，源码包也不等于已公开发布。",
        },
    ]
    ...
    return {
        ...
        "boundary": (
            ...
            "connectivity, production certification, or complete open-source rights clearance."
        ),
    }
