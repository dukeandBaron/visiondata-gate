...
| 现在是否已经全部提交？ | 冻结 RC3 候选已通过其本地完整性门；当前 RC4 Defense Kit 在 PPT/PDF、60 秒视频、附件 ZIP 与清单 QA 闭合前保持 HOLD，官网仍为 `PENDING`。 | Project Status、Submission Checklist | 冻结 RC3 PASS 等于 RC4 包装完成或官网已提交 |
