...
| 代码仓库或等价工程材料 | 运行入口、依赖、配置、示例数据、部署、测试和运行证据 | 唯一 GitHub 主仓、README、锁文件、合成样本与验证脚本 |
...
冻结 RC3 的 PASS 只绑定上述 commit/tree。当前 RC4 Defense Kit 在新版 PPT/PDF、60 秒视频、附件 ZIP 与各自 QA/清单全部闭合前保持 `HOLD_RC4_DEFENSE_KIT`，不得从 RC3 继承 PASS。
