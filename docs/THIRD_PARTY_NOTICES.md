...
This notice records the 54 locked third-party packages in the RC2 environment.
...
Eight dependency records did not expose a single unambiguous SPDX expression
